...
def fact_sm_backlog():
    ...
    df_sm_backlog_new = pd.DataFrame(columns=["OPERACION","CUMPLIMIENTO_CAL","SLA_BACK_CALC","VENCIMIENTO"])
...
def fact_sm_cerrado():
    ...
    df_sm_cerrado_new = pd.DataFrame(columns=["TECNOLOGIA","FECHA_INGRESO_ESTADO_CORTA","ID_COMPANIA"])
