...
def fact_clic_abiertos():
    ...
    if not df_sql.empty:
        ...
        dim_usuario = dim_usuario[dim_usuario.CASO_USUARIO != 'ND'].astype(
            'int64')
...
def fact_clic_resueltos():
    ...
    if not df_sql.empty:
        ...
        df_clic_resueltos['SERVICIO_AFECTADO'] = df_clic_resueltos['SERVICIO_AFECTADO'].fillna(
            'ND')
        df_clic_resueltos['IMPACTO'] = df_clic_resueltos['IMPACTO'].fillna(
            'ND')
        df_clic_resueltos['URGENCIA'] = df_clic_resueltos['URGENCIA'].fillna(
            'ND')
        ...
        df_clic_resueltos['DEPENDENCIA'] = df_clic_resueltos['DEPENDENCIA'].fillna(
            'ND')
        df_clic_resueltos['REGIONAL'] = df_clic_resueltos['REGIONAL'].fillna(
            'ND')
